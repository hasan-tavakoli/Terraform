...
resource "google_service_account_iam_member" "composer_agent_service_account" {
  provider           = google-beta
  service_account_id = "projects/-/serviceAccounts/${var.composer_service_account}"
...
resource "google_composer_environment" "composer_env" {
  ...
  depends_on = [google_service_account_iam_member.composer_agent_service_account]
}
